...
<div className="sticky top-0 z-[1000] block bg-gray py-3 lg:block">
  ...
  <a href="./ourTeam" className="px-5 py-2 text-white transition hover:text-[#2CD3E1] max-[991px]:block md:px-10 lg:px-4">Our Team</a>
      ...
      <div className="relative float-right hidden cursor-pointer select-none p-3 text-2xl max-[991px]:z-[9999] max-[991px]:-mr-3 max-[991px]:block max-[991px]:text-white lg:p-[18px]" tabIndex="0">
        <div className="">
